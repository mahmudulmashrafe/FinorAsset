...
export function TransactionDialog({
  ...
  const dialogContent = (
    <DialogContent className="max-w-md flex flex-col max-h-[90vh] sm:max-h-[620px] p-0 z-[99] overflow-hidden border border-white/50 dark:border-white/20 bg-white/35 dark:bg-zinc-950/40 backdrop-blur-2xl shadow-2xl rounded-2xl md:rounded-3xl" onCloseAutoFocus={(e) => e.preventDefault()}>
